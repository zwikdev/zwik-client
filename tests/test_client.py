...
class TestZwikMultiplePackages(TestCase):
    def test_prefer_default_channels_when_multiple_packages(self):
        ...
        default_channels = [
            "https://userid:zwik_pat_123@zwik.dev.bosch.com/packages/bios",
            "https://userid:zwik_pat_123@zwik.dev.bosch.com/packages/third-party",
            "https://userid:zwik_pat_123@zwik.dev.bosch.com/packages/conda-forge",
        ]
        ...
        result = (
            ...
            FakePackageRecord(
                schannel="https://rb-artifactory.bosch.com/artifactory/tt-rh-ect-tools-generic-release-local/conda/bosch-tt"  # noqa
            ),
        )
