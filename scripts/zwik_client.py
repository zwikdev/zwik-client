...
class ZwikEnvironment(object):
        ...
        if path and os.path.exists(path):
            ...
            with open(path, "r") as fp:
                ...
                if data["yaml_hash"] == self.yaml_hash:
                    ...
                    if VersionOrder(str(script_ver)) < VersionOrder("6.0"):
    ...
    def write_version_lock(self, lock_dep):
        ...
        # Temporarily enforce the use of legacy hashes in lock files
        # to ensure that older clients can process lock files
        # generated by the new client
        data = {
            "script_version": __version__,
            "subdir": subdir,
            "yaml_hash": self.get_legacy_yaml_hash() or self.yaml_hash,
